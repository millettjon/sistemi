        ...
        :feedback {:title "Con Lei e per Lei"
                   ...
                   :text [:div
                          ...
                          [:p "Stiamo lavorando molto per realizzare la visione di Sistemi Moderni. Abbiamo ancora"
                           " una lunga strada davanti a noi, e vogliamo percorrerla con Lei, mirando a creare i"
                           " migliori prodotti e la miglior esperienza possibile per Lei. Il fatto stesso che Lei"
                           " stia leggendo questa pagina ci indica il suo interesse per ciò che Sistemi Moderni"
                           " può offrire.  Non si fermi solo alla lettura!  La preghiamo invece di prendere un"
                           " momento per spiegarci le sue impressioni a riguardo di Sistemi Moderni, e cosa"
                           " desidererebbe che noi facessimo per Lei."]
                          [:p "Per favore segua questo link per riempire un questionario che le occuperà soltanto"
                           " un minuto.  La ricompenseremo spedendole un \"codice di sconto feedback\" che le"
                           " permetterà di risparmiare 10 euro sul suo prossimo acquisto con Sistemi Moderni."
                           " In più, se lei trova i nostri prodotti interessanti e li propone ad un amico, lo"
                           " incoraggi ad indicare il suo codice al momento dell'acquisto: questo aggiungerà altri"
                           " 10 euro al vostro sconto... ed in questo modo gli sconti si possono accumulare"
                           " velocemente!"]
                          [:p "Contiamo molto sui Suoi suggerimenti ed i Suoi commenti, positivi o negativi che"
                           " siano, perché è nostro scopo sincero migliorare i nostri servizi e prodotti.  Per"
                           " qualunque richiesta o suggerimento, non esitate a contattarci: saremo sempre a sua"
                           " disposizione."]
