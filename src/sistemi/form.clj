...
;;   valchromat - oiled
;; ? what should the default finish be?
;; background of color wheel should be adjustable
...
(def shelf-params
  {:width {:type :bounded-number :units "cm" :min 64 :max 240 :default 120 :format fmt/cm}
   ...
   :finish {:type :set :options [:laquer-matte :laquer-satin {:disabled true} :laquer-glossy {:disabled true} :valchromat-raw :valchromat-oiled] :default :laquer-matte
